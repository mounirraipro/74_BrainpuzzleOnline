...
const SUPPORT_EMAIL = 'hello@brainpuzzle.online';

export const metadata: Metadata = {
    title: 'Contact Brain Puzzle',
    description: 'Get in touch with the Brain Puzzle team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Brain Puzzle', 'Brain Puzzle support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
