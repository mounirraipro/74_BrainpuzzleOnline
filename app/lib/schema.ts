...
const SITE_URL = 'https://brainpuzzle.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Brain Puzzle',
        url: SITE_URL,
        description: 'Play Brain Puzzle free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Brain Puzzle online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
