...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Brain Puzzle puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Brain Puzzle categories'],
  alternates: {
