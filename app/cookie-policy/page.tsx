...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Brain Puzzle uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Brain Puzzle cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Brain Puzzle uses them, and how you can
                ...
                <p>Brain Puzzle uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Brain Puzzle.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@brainpuzzle.online</strong>.
                </p>
            </div>
        </>
    );
