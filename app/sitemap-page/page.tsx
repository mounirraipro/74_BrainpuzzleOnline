...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Brain Puzzle. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Brain Puzzle sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Brain Puzzle' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Brain Puzzle?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Brain Puzzle.</p>
                </div>
            </div>
