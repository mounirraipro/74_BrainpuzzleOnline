...
export const metadata: Metadata = {
    ...
    description: 'Brain Puzzle is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Brain Puzzle accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Brain Puzzle accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Brain Puzzle is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Brain Puzzle presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Brain Puzzle. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@brainpuzzle.online</strong></li>
                </ul>
                <p>
